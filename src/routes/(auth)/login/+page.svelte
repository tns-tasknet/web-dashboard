			...
			<form class="card-body gap-5" onsubmit={onSubmit} autocomplete="on" novalidate>
					...
					>
						...
						>
							<path
								...
								stroke-width="1.5"
								d="M21.75 7.5v9a2.25 2.25 0 0 1-2.25 2.25H4.5A2.25 2.25 0 0 1 2.25 16.5v-9m19.5 0A2.25 2.25 0 0 0 19.5 5.25H4.5A2.25 2.25 0 0 0 2.25 7.5m19.5 0l-9 6-9-6"
							/>
						</svg>
				...
				<div class="flex items-center justify-between text-sm">
					<div>
						...
						<a class="ml-1 link link-primary" href="/signup">Crear cuenta</a>
					</div>
				</div>
			</form>
		</div>
